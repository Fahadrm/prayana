    ...
    def get_hsn(self):
        ...
        for i in self:
            ...
            dd.id as move_id,
                ...
                (ml.price_total-ml.price_subtotal) as tax_total,
            ...
            for ans1 in self.env.cr.dictfetchall():
                ...
                tax_total = ans1['tax_total'] if ans1['tax_total'] else 0
                ...
                so_order = {
                    ...
                    'tax_total':tax_total if tax_total else 0,
                }
    ...
    def _calc_subtotal(self):
        for rec in self:
            ...
            for l in rec.invoice_line_ids:
                subtotal_amount += ((l.quantity) * (l.price_unit))
                print(subtotal_amount, 'subtotal')
